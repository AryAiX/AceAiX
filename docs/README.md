...
| 25 | [`25-the-waitlist.md`](./25-the-waitlist.md) | The early-access form on the marketing site: the two backends it can post to, why an edge function sits between the page and the table, the guardian rule and the three places it is enforced, and double opt-in | Web + Backend + Marketing |
