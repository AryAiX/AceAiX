...
| 25 | [`25-the-waitlist.md`](./25-the-waitlist.md) | The launch sign-up on the marketing site: why an edge function sits between the page and the table, the 18+ gate and the three places it is enforced, and double opt-in | Web + Backend + Marketing |
