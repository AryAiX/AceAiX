...
export const meetups = {
  ...
  adultsOnlyBody: 'Искать партнёров для игры можно только с 18 лет. Пока используйте «Обзор», «Челленджи» и «Возможности».',
  adultsOnlyTitle: 'Игры — только для взрослых',
  ...
  discardTitle: 'Отменить эту игру?',
  discardBody: 'То, что ты заполнил, не сохранится.',
