...
export const settings = {
  ...
  scoutingRecruiterOnlyBody: 'Настройки скаутинга — для тренеров, клубов и скаутов. Спортсмены указывают вид спорта и готовность в профиле.',
  scoutingRecruiterOnlyTitle: 'Для тренеров и клубов',
