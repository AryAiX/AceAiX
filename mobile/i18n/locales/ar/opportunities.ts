...
export const opportunities = {
  ...
  post: {
    title: 'انشر فرصة',
    discardTitle: 'تجاهل هذه الفرصة؟',
    discardBody: 'لن يُحفَظ ما أدخلته.',
    recruiterOnlyTitle: 'للمدربين والأندية',
    recruiterOnlyBody: 'المدربون والأندية والكشّافون وحدهم يستطيعون نشر الفرص. ما زال بإمكانك التصفح والتقديم من الفرص.',
    submit: 'انشرها',
