...
export const meetups = {
  ...
  adultsOnlyBody: 'البحث عن أشخاص للعب معهم متاح فقط بعد بلوغ 18. حتى ذلك الحين، استخدم الاستكشاف والتحديات والفرص.',
  adultsOnlyTitle: 'اللعب للبالغين',
  ...
  discardTitle: 'تجاهل هذه المباراة؟',
