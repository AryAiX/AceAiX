...
export const settings = {
  ...
  scoutingRecruiterOnlyBody: 'تفضيلات الكشافة مخصّصة للمدربين والأندية والكشّافين. الرياضيون يضبطون رياضتهم وانفتاحهم من ملفهم الشخصي.',
  scoutingRecruiterOnlyTitle: 'للمدربين والأندية',
