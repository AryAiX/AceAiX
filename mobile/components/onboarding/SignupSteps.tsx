...
/** Use explicit fields on web so keyboard entry works consistently in every browser. */
function WebDateField({
  ...
  const digits = (input: string, maxLength: number) =>
